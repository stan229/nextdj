...
//        this.lowEQ = this.createEQ(0);
//        this.midEQ  = this.createEQ(2);
//        this.highEQ  = this.createEQ(1);
    ...
    createEQ : function (freqType) {
        var filter = this.ac.createBiquadFilter();
        this.source.connect(filter);
        filter.connect(this.ac.destination);

        filter.type = freqType;
//        filter.frequency.minValue = minFreq;
//        filter.frequency.maxValue = maxFreq;
//        filter.frequency.value = (maxFreq + minFreq) / 2;
