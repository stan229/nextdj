...
WaveSurfer.WebAudio = {
    ...
    play     : function (start, end, delay) {
        ...
        this.lowEQ.type = this.lowEQ.LOWSHELF;
        this.midEQ.type = this.midEQ.PEAKING;
        this.highEQ.type = this.highEQ.HIGHSHELF;

        this.lowEQ.frequency.value = 500.0;
        this.midEQ.frequency.value = 5000.0;
        this.highEQ.frequency.value = 10000.0;
